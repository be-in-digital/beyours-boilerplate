 ...
 *
 * The layout half of "Minuit" (Fast food), beside the colour half in theme.css
 * and the type half in fonts.ts. Generated from the "fast-food-minuit" demo identity
