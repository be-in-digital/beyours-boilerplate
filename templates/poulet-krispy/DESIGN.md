...
Croustillant niveau maximal. Marque de démonstration : **Krispy Krush**.

Identité : titres en Passion One, texte en Gabarito ;
signature hsl(26 90% 38%) ; mise en page de démo « hero collage, carte cartes photo ».

Aperçu interactif du design complet : `demos/home.html?t=poulet-krispy` (ou la
