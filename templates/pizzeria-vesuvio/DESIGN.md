...
La pizza qui gronde. Marque de démonstration : **Vesuvio**.

Identité : titres en Anton, texte en Archivo Narrow ;
signature hsl(0 78% 44%) ; mise en page de démo « hero affiche typographique, carte bento ».

Aperçu interactif du design complet : `demos/home.html?t=pizzeria-vesuvio` (ou la
