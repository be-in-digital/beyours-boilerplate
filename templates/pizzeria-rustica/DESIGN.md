...
Pizzeria de campagne. Marque de démonstration : **Rustica**.

Identité : titres en Libre Caslon Text, texte en Instrument Sans ;
signature hsl(18 55% 38%) ; mise en page de démo « hero duo texte / photo, carte tickets empilés ».

Aperçu interactif du design complet : `demos/home.html?t=pizzeria-rustica` (ou la
