 ...
 *
 * The layout half of "Tokyo Night" (Asian), beside the colour half in theme.css
 * and the type half in fonts.ts. Generated from the "asiatique-tokyonight" demo identity
