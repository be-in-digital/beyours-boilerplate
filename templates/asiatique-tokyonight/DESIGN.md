...
Midnight ramen bar. Demo brand: **Tokyo Night**.

Identity: Space Grotesk for headings, Karla for body text;
signature hsl(355 85% 45%); demo layout "hero: straight banner / menu: sticky tabs".

Interactive preview of the full design: `demos/home.html?t=asiatique-tokyonight` (or the
