...
Braise, cendre et farine. Marque de démonstration : **Forno Nero**.

Identité : titres en Space Grotesk, texte en Karla ;
signature hsl(24 90% 36%) ; mise en page de démo « hero diagonale couleur / photo, carte registre numéroté ».

Aperçu interactif du design complet : `demos/home.html?t=pizzeria-fornonero` (ou la
