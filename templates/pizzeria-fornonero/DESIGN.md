...
Embers, ash and flour. Demo brand: **Forno Nero**.

Identity: Space Grotesk for headings, Karla for body text;
signature hsl(24 90% 36%); demo layout "hero: color / photo diagonal / menu: numbered ledger".

Interactive preview of the full design: `demos/home.html?t=pizzeria-fornonero` (or the
