...
The late-night slice. Demo brand: **Pizza Notte**.

Identity: Bricolage Grotesque for headings, Archivo for body text;
signature hsl(262 60% 45%); demo layout "hero: straight banner / menu: sticky tabs".

Interactive preview of the full design: `demos/home.html?t=pizzeria-notte` (or the
