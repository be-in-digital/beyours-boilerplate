 ...
 *
 * The layout half of "La Verte" (Fast food), beside the colour half in theme.css
 * and the type half in fonts.ts. Generated from the "fast-food-verte" demo identity
