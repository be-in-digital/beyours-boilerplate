 ...
 *
 * The layout half of "Smash" (Fast food), beside the colour half in theme.css and
 * the type half in fonts.ts. Taken from the "fast-food-smash" demo identity, the one
