 ...
 *
 * The layout half of "Izakaya" (Asian), beside the colour half in theme.css and
 * the type half in fonts.ts. Taken from the "asiatique-izakaya" demo identity, the one
