 ...
 *
 * The layout half of "Piri West" (Chicken), beside the colour half in theme.css
 * and the type half in fonts.ts. Generated from the "poulet-piriwest" demo identity
