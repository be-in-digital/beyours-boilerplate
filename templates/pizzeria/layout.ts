 ...
 *
 * The layout half of "Trattoria" (Pizzeria), beside the colour half in theme.css and
 * the type half in fonts.ts. Taken from the "pizzeria-trattoria" demo identity, the one
