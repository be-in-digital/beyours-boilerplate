...
Gentle steam, fresh bamboo. Demo brand: **Maison Bambou**.

Identity: Sora for headings, Manrope for body text;
signature hsl(140 45% 30%); demo layout "hero: text / photo split / menu: photo cards".

Interactive preview of the full design: `demos/home.html?t=asiatique-bambou` (or the
