...
Editorial, like a magazine. Demo brand: **Pizzeria Milano**.

Identity: Playfair Display for headings, Public Sans for body text;
signature hsl(352 78% 40%); demo layout "hero: magazine / menu: photo mosaic".

Interactive preview of the full design: `demos/home.html?t=pizzeria-milano` (or the
