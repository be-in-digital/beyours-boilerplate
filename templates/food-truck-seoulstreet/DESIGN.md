...
Korean street food, low fire and gochujang. Demo brand: **Seoul Street**.

Identity: Space Grotesk for headings, Karla for body text;
signature hsl(350 85% 46%); demo layout "hero: straight banner / menu: sticky tabs".

Interactive preview of the full design: `demos/home.html?t=food-truck-seoulstreet` (or the
