...
K-chicken, double friture. Marque de démonstration : **Seoul Fried**.

Identité : titres en Space Grotesk, texte en Karla ;
signature hsl(348 80% 47%) ; mise en page de démo « hero bandeau direct, carte onglets collants ».

Aperçu interactif du design complet : `demos/home.html?t=poulet-seoulfried` (ou la
